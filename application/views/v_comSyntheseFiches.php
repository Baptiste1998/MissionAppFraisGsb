...
<nav id="vue-nav">
	<ul>
		<li><?php echo anchor('c_comptable/paiementFiches', 'Fiches mises en paiement', 'class="link" title="Rembourser les fiches de frais"');?></li>
		<li>Fiches remboursées</li>
	</ul>
</nav>
<div id="vue-titre">
	<h2>Synthèse des fiches de frais remboursées</h2>
</div>
<div id="vue-contenu">
